		...
		<div class="rtin-sec-title-area row">
			...
			<?php if ( $data['all_link_display'] ): ?>
				<div class="col-md-6 col-4">
					<div class="rtin-viewall"><a href="<?php echo esc_url( $shop_permalink ); ?>"><?php esc_html_e( 'See More', 'metro-core' );?> <span class="fa fa-chevron-right"></span></a></div>
				</div>
			<?php endif; ?>
		</div>
	<?php endif; ?>
				...
				<div class="col-md-4 col-12">
					<div class="rtin-item media">
						<a class="rtin-thumb" href="<?php the_permalink();?>">
							...
							?>
							<div class="rtin-icon"><span class="flaticon-plus-symbol"></span></div>
						</a>
