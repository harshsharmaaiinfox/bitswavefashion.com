	...
	<div class="rt-el-post-4 owl-wrap">
		<div class="custom-nav-1">
			<div class="owl-custom-nav custom-nav-1-inner">
				<div class="owl-prev"><span class="fa fa-angle-left"></span></div><h3 class="custom-nav-1-title"><?php echo esc_html( $data['title'] );?></h3><div class="owl-next"><span class="fa fa-angle-right"></span></div>
			</div>
