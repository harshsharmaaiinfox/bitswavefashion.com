...
<div class="rt-el-contact">
	<ul>
		<?php if ( $data['address'] ): ?>
			<li>
				<div class="rtin-icon"><span class="flaticon-placeholder"></span></div>
		...
		<?php if ( $data['phone'] ): ?>
			<li>
				<div class="rtin-icon"><span class="flaticon-phone-call"></span></div>
				<div class="rtin-content">
		...
		<?php if ( $data['email'] ): ?>
			<li>
				<div class="rtin-icon"><span class="flaticon-envelope"></span></div>
				<div class="rtin-content">
