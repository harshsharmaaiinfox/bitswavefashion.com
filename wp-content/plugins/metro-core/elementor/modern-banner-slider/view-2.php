                ...
                <div class="row align-items-center">
                            ...
                            <?php foreach ( $data['items'] as $item ) : ?>
                                ...
                                <div class="slick-slide">
                                    ...
                                    <?php if ( $item['linktext'] ): ?>
                                     <div class="item-btn">
                                        <a <?php echo $attr;?>><?php echo esc_html( $item['linktext'] );?>  <span class="fas fa-long-arrow-alt-right"></span></a>
                                     </div>
                                <?php endif; ?>                                     
                                </div>
                            <?php endforeach; ?>  
                    ...
                    <div class="slider-price">
                     ...
                     <div class="slick-navigation" data-sal="zoom-in" data-sal-duration="1000">
                        ...
                        <div class="nav-btn">
                            <button id="slick-prev" type="button" class="slick-arrow prev-btn"><span class="fas fa-long-arrow-alt-left"></span></button>
                            <button id="slick-next" type="button" class="slick-arrow next-btn"><span class="fas fa-long-arrow-alt-right"></span></button>
                        </div>
                        <?php endif; ?> 
                    </div>
                </div>
