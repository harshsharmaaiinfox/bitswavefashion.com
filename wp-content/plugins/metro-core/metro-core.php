...
class Metro_Core {
	...
	public function __construct() {
		...
		add_action( 'rdtheme_social_share', [ $this, 'social_share' ] );
		add_action( 'plugins_loaded', [ $this, 'php_version_check' ] );
	}
	...
	public function after_theme_loaded() {
		...
		require_once METRO_CORE_BASE_DIR . 'inc/plugin-hooks.php'; // Plugin Hooks
